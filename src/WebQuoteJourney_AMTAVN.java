...
public class WebQuoteJourney_AMTAVN {
    ...
    void Method_WebQuoteJourney_AMT() throws Exception {
        ...
        driver.get("https://uat-quote.avantitravelinsurance.co.uk/quote/policy-details");
       ...
       */
        ...
        valueDeptDate.sendKeys("20/03/2023");
        Thread.sleep(1000);
      ...
      //  valueCtnQt.click();
        ...
        if (driver.findElement(By.xpath("//*[@id='btnSubmit']")).isDisplayed()) {
            ...
            Thread.sleep(1000);
            driver.findElement(By.xpath("//*[@id='traveler_last_name_0']")).sendKeys("PreLive"); //Traveller last name
            ...
            if (driver.findElement(By.xpath("//*[@id='medical_dec_submit_btn']")).isDisplayed()) {
                ...
                Thread.sleep(1000);
                clickElementWithJS(driver, By.xpath("//*[@id=\"ANNUAL_MULTI_TRIP_DELUXE_BTN\"]"));
                Thread.sleep(1000);
                ...
                if (driver.findElement(By.xpath("//*[@id='cancellationCoverChangeSubmit']")).isDisplayed()) {
                    ...
                    if (orgEmail2.isDisplayed() && orgEmail2.isEnabled()) {
                        orgEmail2.clear();
                        orgEmail2.sendKeys("livetesttharushiunification@gmail.com");
                    }
