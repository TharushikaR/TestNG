...
public class PreLiveSTSHubQTJourney {
    @Test//(invocationCount = 4)
    void Method_PreLive_HubQuote() throws Exception {
       // ScreenRecorderUtils2.startRecord("Method_PreLive_HubQuote");
       ...
       // driver.get("https://prelive-hub.intertrav.co.uk/sts/login");
       ...
       // System.out.println("No. of Iframes on this Web Page are: " +numberOfTags);
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//*[@id=\"organiserDTOlastName\"]")).sendKeys("Prelive");
        Thread.sleep(1000);
      ...
      //  Thread.sleep(1000);
       ...
       /* Thread.sleep(5000);
        ...
        Thread.sleep(5000);
        clickElementWithJS(driver,By.xpath("//*[@id=\"paymentOptionId\"]"));
