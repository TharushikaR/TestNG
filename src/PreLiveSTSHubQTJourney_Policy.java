...
public class PreLiveSTSHubQTJourney_Policy {
    @Test(invocationCount = 2)
    void Method_PreLive_HubQuote_Policy() throws Exception {
        ScreenRecorderUtils2.startRecord("Method_PreLive_HubQuote_Policy");
